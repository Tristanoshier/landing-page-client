    ...
    const filterSearch = () => {
      ...
      if (topic === "music") {
        ...
        filtered = props.programmingPosts.filter((post) => {
          let results =
            searchTerm === "" ? props.programmingPosts : result(post);
          return results;
        });
      } else if (topic === "blog") {
        filtered = props.blogPosts.filter((post) => {
          let results = searchTerm === "" ? props.blogPosts : result(post);
          return results;
        });
      } else if (topic === "") {
  ...
  return (
    <div>
      <Form className="search-form" onSubmit={handleSubmit}>
        <Input
          className={props.darkMode ? "topic-filter" : "topic-filter light"}
          type="select"
          name="topic"
          value={topic}
          onChange={(e) => chooseTopic(e)}
        >
        ...
        <input
          className={props.darkMode ? "searchbar" : "searchbar light"}
      ...
      {postMapper(filteredPosts, null, props.darkMode)}
